...
from .losses import Keypoint3DLoss, Keypoint2DLoss, ParameterLoss, Keypoint3DNLLLoss_wo_align
from . import MANO
import numpy as np
import pickle
import os
...
class HAMER_DIAG(pl.LightningModule):
    ...
    def compute_loss(self, batch: Dict, output: Dict, uncertainty: Dict, train: bool = True) -> torch.Tensor:
        ...
        pred_keypoint_3d_cov = uncertainty['keypoint_3d_cov']
        ...
        loss_keypoints_3d = self.keypoint_3d_loss(pred_keypoints_3d, pred_keypoint_3d_cov.reshape(batch_size, -1, 3), gt_keypoints_3d, pelvis_id=0)
